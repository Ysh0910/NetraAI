  ...
  return (
    <div className="h-full bg-card border border-border rounded overflow-hidden flex flex-col">
      ...
      <div className="px-3 py-2 border-b border-border bg-muted/30 flex items-center justify-between">
        ...
        <span className="text-[10px] text-muted-foreground">4 UNITS</span>
      </div>
        ...
        {soldiers.map((soldier) => (
          ...
          >
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <StatusIndicator status={soldier.status} />
            </div>
            ...
            <div className="flex items-center justify-between">
              <BatteryIndicator level={soldier.battery} />
      ...
      <div className="px-3 py-2 border-t border-border bg-muted/30 grid grid-cols-4 gap-2 text-center">
        <div>
          ...
          <div className="text-sm font-bold text-success">
            {soldiers.filter((s) => s.status === "nominal").length}
          </div>
        </div>
        <div>
          <div className="text-[10px] text-muted-foreground">WARNING</div>
          <div className="text-sm font-bold text-accent">
            {soldiers.filter((s) => s.status === "warning").length}
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="text-sm font-bold text-muted-foreground">
            {soldiers.filter((s) => s.status === "offline").length}
          </div>
        </div>
      </div>
    </div>
